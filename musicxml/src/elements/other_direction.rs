use crate::datatypes::{
  Color, FontFamily, FontSize, FontStyle, FontWeight, Id, LeftCenterRight, SmuflGlyphName, Tenths, Valign, YesNo,
};
...
/// The [OtherDirection] element is used to define any [Direction][super::Direction] symbols not yet in the MusicXML format.
///
...
pub struct OtherDirection {
  ...
  pub attributes: OtherDirectionAttributes,
