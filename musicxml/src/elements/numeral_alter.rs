...
pub struct NumeralAlterAttributes {
  ...
  /// The `location` attribute indicates whether the alteration should appear to the left or the right of the [NumeralRoot][super::NumeralRoot].
...
pub struct NumeralAlter {
  ...
  pub attributes: NumeralAlterAttributes,
