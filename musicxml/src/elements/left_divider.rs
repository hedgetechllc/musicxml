...
/// The [LeftDivider] element indicates the presence or absence of a system divider (also known as a system separation mark) displayed on the left side of the page.
///
...
pub struct LeftDivider {
  ...
  pub attributes: LeftDividerAttributes,
