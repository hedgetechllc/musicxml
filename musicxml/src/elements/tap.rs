use crate::datatypes::{AboveBelow, Color, FontFamily, FontSize, FontStyle, FontWeight, TapHand, Tenths};
...
pub struct TapAttributes {
  ...
  /// Specifies the symbol to use if the element is empty. It is ignored if the tap glyph is already specified by the element content.
