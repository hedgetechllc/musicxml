use crate::datatypes::{Color, FontFamily, FontSize, FontStyle, FontWeight, Tenths};
...
/// Values for the [Suffix] element include plus and the accidental values sharp, flat, natural, double-sharp, flat-flat, and sharp-sharp.
/// 
